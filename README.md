...
- `src/agents/source_adapters.py`: per-source LLM analysis lanes (auth, openstack, linux, apache)
...
- pipeline metadata
- detected source-agent findings (HIGH + MEDIUM severity, up to 30)
...
- [Demo 3](https://docs.google.com/presentation/d/191mxJii2GuPi_ugox0UtLs1aa2Td9zIuW_mPsNQD7vQ/edit?usp=sharing)
- [Final Demo](https://docs.google.com/presentation/d/1pLYht4iw7kVB-69FwjBy9dALr-oXNxQ7XcFgNoOBqJM/edit?usp=sharing)
...
- [Final Demo Video](https://drive.google.com/file/d/1Zx93qKnWLVfUqK0A1Znjbf1Icv5K8coR/view?usp=sharing)

## Final Code Review
- [Final Code Review Video](https://youtu.be/aIfnChlpIik)
